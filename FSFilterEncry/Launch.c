...
)
{
	...
	pstDriverObject->MajorFunction[IRP_MJ_CREATE] = SfCreate;
	pstDriverObject->MajorFunction[IRP_MJ_CREATE_NAMED_PIPE] = SfCreate;
	pstDriverObject->MajorFunction[IRP_MJ_CREATE_MAILSLOT] = SfCreate;
